    ...
    <body>
        ...
        if(isset($_POST['accion']))
        {
            ...
            if($_POST['accion'] == "modify")
            {
                ...
                $consulta = mysqli_query($enlace, "select * from bateriapreguntas where id_tema = $tema  ");
                ...
                if(isset($_POST['selPregunta']))
                {
                    ...
                    {
                        if($_POST['selMod'] == $fila['correcta']){
                            $selMod = $_POST['selMod'];
                            $mod = $_POST['mod'];
                            $selPregunta = $_POST['selPregunta'];

                            $nombre = mysqli_query($enlace, "update bateriapreguntas set $selMod = $mod where id = $selPregunta "); //mirar esto
                        }
                    }
                
                }
            }
            if($_POST['accion'] == "erase")
            {
                ...
                if(isset($_POST['selPregunta'])){
                    ...
                    $nombre = mysqli_query($enlace, "delete from bateriapreguntas where id =  $selpregunta"); //mirar esto
                }
            }           
        }
